...
public class Resource extends AppCompatActivity {
    ...
    public void ltcq  (View v) {
        Intent it = new Intent(Resource.this, LTCQualifications.class);
        startActivity(it);
    }
    public void ltcaq  (View v) {
        Intent it = new Intent(Resource.this, LTCapplicationQualification.class);
        startActivity(it);
    }
    public void ltci  (View v) {
        Intent it = new Intent(Resource.this, LTCItem.class);
        startActivity(it);
    }
}
